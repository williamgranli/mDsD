...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Payment Manager</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Payment.impl.PaymentComponent_PaymentManagerImpl#getPaymentDetails <em>Payment Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentComponent_PaymentManagerImpl extends MinimalEObjectImpl.Container implements PaymentComponent_PaymentManager {
	...
	protected EClass eStaticClass() {
		return PaymentPackage.Literals.PAYMENT_COMPONENT_PAYMENT_MANAGER;
	}
	...
	public void setPaymentDetails(String newPaymentDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PaymentPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER__PAYMENT_DETAILS, oldPaymentDetails, paymentDetails));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PaymentPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER__PAYMENT_DETAILS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case PaymentPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER___MAKE_PAYMENT__STRING_INT_INT_INT_STRING_STRING_STRING:
				...
				return null;
			case PaymentPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER___IS_CREDIT_CARD_VALID__STRING_STRING_STRING_STRING_STRING_STRING:
