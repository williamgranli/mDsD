...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Booking</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Booking.impl.BookingComponent_BookingImpl#getArrivalDate <em>Arrival Date</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_BookingImpl#getDepartureDate <em>Departure Date</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_BookingImpl#getReferenceNumber <em>Reference Number</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_BookingImpl#getCurrentCost <em>Current Cost</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookingComponent_BookingImpl extends MinimalEObjectImpl.Container implements BookingComponent_Booking {
	...
	protected EClass eStaticClass() {
		return BookingPackage.Literals.BOOKING_COMPONENT_BOOKING;
	}
	...
	public void setArrivalDate(Date newArrivalDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_BOOKING__ARRIVAL_DATE, oldArrivalDate, arrivalDate));
	}
	...
	public void setDepartureDate(Date newDepartureDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_BOOKING__DEPARTURE_DATE, oldDepartureDate, departureDate));
	}
	...
	public void setReferenceNumber(String newReferenceNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_BOOKING__REFERENCE_NUMBER, oldReferenceNumber, referenceNumber));
	}
	...
	public void setCurrentCost(int newCurrentCost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_BOOKING__CURRENT_COST, oldCurrentCost, currentCost));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BookingPackage.BOOKING_COMPONENT_BOOKING__ARRIVAL_DATE:
				return getArrivalDate();
			case BookingPackage.BOOKING_COMPONENT_BOOKING__DEPARTURE_DATE:
				return getDepartureDate();
			case BookingPackage.BOOKING_COMPONENT_BOOKING__REFERENCE_NUMBER:
				return getReferenceNumber();
			case BookingPackage.BOOKING_COMPONENT_BOOKING__CURRENT_COST:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BookingPackage.BOOKING_COMPONENT_BOOKING___BOOKING_OBJECT:
				BookingObject();
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___BOOKING__DATE_DATE:
				Booking((Date)arguments.get(0), (Date)arguments.get(1));
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___ADD_ADDITIONAL_SERVICE_TO_BOOKING__BOOKINGCOMPONENT_ADDITIONALSERVICE:
				addAdditionalServiceToBooking((BookingComponent_AdditionalService)arguments.get(0));
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___BOOKING__STRING_DATE_DATE_STRING_STRING_STRING_STRING_STRING_STRING_STRING_STRING_STRING:
				...
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___ADD_ROOM_TO_BOOKING__BOOKINGCOMPONENT_ROOMTYPE:
				addRoomToBooking((BookingComponent_RoomType)arguments.get(0));
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___REMOVE_ROOM_FROM_BOOKING__STRING:
				removeRoomFromBooking((String)arguments.get(0));
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___UPDATE_BOOKING__STRING_DATE_DATE:
				updateBooking((String)arguments.get(0), (Date)arguments.get(1), (Date)arguments.get(2));
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___REMOVE_ADDITIONAL_SERVICE_FROM_BOOKING__BOOKINGCOMPONENT_ADDITIONALSERVICE:
				removeAdditionalServiceFromBooking((BookingComponent_AdditionalService)arguments.get(0));
				return null;
			case BookingPackage.BOOKING_COMPONENT_BOOKING___CURRENT_COST:
				return currentCost();
			case BookingPackage.BOOKING_COMPONENT_BOOKING___UPDATE_PAYMENT_DETAILS__BOOKINGCOMPONENT_PAYMENTDETAILS:
