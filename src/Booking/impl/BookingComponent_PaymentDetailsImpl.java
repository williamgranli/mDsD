...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Payment Details</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getLastName <em>Last Name</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getCcNumber <em>Cc Number</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getCcv <em>Ccv</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getExpiryMonth <em>Expiry Month</em>}</li>
 *   <li>{@link Booking.impl.BookingComponent_PaymentDetailsImpl#getExpiryYear <em>Expiry Year</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookingComponent_PaymentDetailsImpl extends MinimalEObjectImpl.Container implements BookingComponent_PaymentDetails {
	...
	protected EClass eStaticClass() {
		return BookingPackage.Literals.BOOKING_COMPONENT_PAYMENT_DETAILS;
	}
	...
	public void setFirstName(String newFirstName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__FIRST_NAME, oldFirstName, firstName));
	}
	...
	public void setLastName(String newLastName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__LAST_NAME, oldLastName, lastName));
	}
	...
	public void setAddress(String newAddress) {
		...
		address = newAddress;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__ADDRESS, oldAddress, address));
	}
	...
	public void setCcNumber(String newCcNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__CC_NUMBER, oldCcNumber, ccNumber));
	}
	...
	public void setCcv(String newCcv) {
		...
		ccv = newCcv;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__CCV, oldCcv, ccv));
	}
	...
	public void setExpiryMonth(String newExpiryMonth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__EXPIRY_MONTH, oldExpiryMonth, expiryMonth));
	}
	...
	public void setExpiryYear(String newExpiryYear) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__EXPIRY_YEAR, oldExpiryYear, expiryYear));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__FIRST_NAME:
				return getFirstName();
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__LAST_NAME:
				return getLastName();
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__ADDRESS:
				return getAddress();
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__CC_NUMBER:
				return getCcNumber();
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__CCV:
				return getCcv();
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__EXPIRY_MONTH:
				return getExpiryMonth();
			case BookingPackage.BOOKING_COMPONENT_PAYMENT_DETAILS__EXPIRY_YEAR:
