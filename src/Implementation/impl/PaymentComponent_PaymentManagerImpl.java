 ...
 *   <li>{@link Implementation.impl.PaymentComponent_PaymentManagerImpl#getPayments <em>Payments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentComponent_PaymentManagerImpl extends MinimalEObjectImpl.Container implements PaymentComponent_PaymentManager {
	 ...
	 * @ordered
	 */
	protected EList<PaymentComponent_Payment> payments;
	 ...
	 * @generated
	 */
	public EList<PaymentComponent_Payment> getPayments() {
		if (payments == null) {
			payments = new EObjectResolvingEList<PaymentComponent_Payment>(PaymentComponent_Payment.class, this, ImplementationPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER__PAYMENTS);
		}
		return payments;
	}
	 ...
	 * @generated
	 */
	public void payForBooking(int amount, String ccNumber, String ccv, String expiryMonth, String expiryYear, String firstName, String lastName) {
	 ...
	 * @generated
	 */
	public void reserveFunds(int amount, String ccNumber, String ccv, String expiryMonth, String expiryYear, String firstName, String lastName) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	 ...
	 * @generated
	 */
	public void unreserveFunds(int amount, String ccNumber, String ccv, String expiryMonth, String expiryYear, String firstName, String lastName) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ImplementationPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER__PAYMENTS:
				return getPayments();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ImplementationPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER__PAYMENTS:
				getPayments().clear();
				getPayments().addAll((Collection<? extends PaymentComponent_Payment>)newValue);
				return;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ImplementationPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER___PAY_FOR_BOOKING__INT_STRING_STRING_STRING_STRING_STRING_STRING:
				payForBooking((Integer)arguments.get(0), (String)arguments.get(1), (String)arguments.get(2), (String)arguments.get(3), (String)arguments.get(4), (String)arguments.get(5), (String)arguments.get(6));
				return null;
			case ImplementationPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER___RESERVE_FUNDS__INT_STRING_STRING_STRING_STRING_STRING_STRING:
				reserveFunds((Integer)arguments.get(0), (String)arguments.get(1), (String)arguments.get(2), (String)arguments.get(3), (String)arguments.get(4), (String)arguments.get(5), (String)arguments.get(6));
				return null;
			case ImplementationPackage.PAYMENT_COMPONENT_PAYMENT_MANAGER___UNRESERVE_FUNDS__INT_STRING_STRING_STRING_STRING_STRING_STRING:
				unreserveFunds((Integer)arguments.get(0), (String)arguments.get(1), (String)arguments.get(2), (String)arguments.get(3), (String)arguments.get(4), (String)arguments.get(5), (String)arguments.get(6));
				return null;
