...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Booking Component Room Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Implementation.impl.BookingComponent_RoomTypeImpl#getRoomType <em>Room Type</em>}</li>
 *   <li>{@link Implementation.impl.BookingComponent_RoomTypeImpl#getCost <em>Cost</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookingComponent_RoomTypeImpl extends MinimalEObjectImpl.Container implements BookingComponent_RoomType {
	...
	protected EClass eStaticClass() {
		return ImplementationPackage.Literals.BOOKING_COMPONENT_ROOM_TYPE;
	}
	...
	public void setRoomType(String newRoomType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.BOOKING_COMPONENT_ROOM_TYPE__ROOM_TYPE, oldRoomType, roomType));
	}
	...
	public void setCost(int newCost) {
		...
		cost = newCost;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.BOOKING_COMPONENT_ROOM_TYPE__COST, oldCost, cost));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImplementationPackage.BOOKING_COMPONENT_ROOM_TYPE__ROOM_TYPE:
				return getRoomType();
			case ImplementationPackage.BOOKING_COMPONENT_ROOM_TYPE__COST:
				return getCost();
		}
