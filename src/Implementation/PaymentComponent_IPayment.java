...
public interface PaymentComponent_IPayment extends EObject {
	 ...
	 * @generated
	 */
	boolean makePayment(String ccNumber, String ccv, int expiryMonth, int expiryYear, String firstName, String lastName, double price);
	 ...
	 * @generated
	 */
	boolean validateCC(String ccNumber, String ccv, int expiryMonth, int expiryYear, String firstName, String lastName, double price);
