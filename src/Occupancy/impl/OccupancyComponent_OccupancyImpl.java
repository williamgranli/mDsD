...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Occupancy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Occupancy.impl.OccupancyComponent_OccupancyImpl#getRoomNumber <em>Room Number</em>}</li>
 *   <li>{@link Occupancy.impl.OccupancyComponent_OccupancyImpl#getCheckInDateTime <em>Check In Date Time</em>}</li>
 *   <li>{@link Occupancy.impl.OccupancyComponent_OccupancyImpl#getCheckOutDateTime <em>Check Out Date Time</em>}</li>
 *   <li>{@link Occupancy.impl.OccupancyComponent_OccupancyImpl#getGuest <em>Guest</em>}</li>
 *   <li>{@link Occupancy.impl.OccupancyComponent_OccupancyImpl#getBookingReference <em>Booking Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OccupancyComponent_OccupancyImpl extends MinimalEObjectImpl.Container implements OccupancyComponent_Occupancy {
	...
	protected EClass eStaticClass() {
		return OccupancyPackage.Literals.OCCUPANCY_COMPONENT_OCCUPANCY;
	}
	...
	public void setRoomNumber(int newRoomNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__ROOM_NUMBER, oldRoomNumber, roomNumber));
	}
	...
	public void setCheckInDateTime(int newCheckInDateTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__CHECK_IN_DATE_TIME, oldCheckInDateTime, checkInDateTime));
	}
	...
	public void setCheckOutDateTime(int newCheckOutDateTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__CHECK_OUT_DATE_TIME, oldCheckOutDateTime, checkOutDateTime));
	}
	...
	public EList<OccupancyComponent_Guest> getGuest() {
		if (guest == null) {
			guest = new EObjectResolvingEList<OccupancyComponent_Guest>(OccupancyComponent_Guest.class, this, OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__GUEST);
		}
		return guest;
	}
	...
	public void setBookingReference(String newBookingReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__BOOKING_REFERENCE, oldBookingReference, bookingReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__ROOM_NUMBER:
				return getRoomNumber();
			case OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__CHECK_IN_DATE_TIME:
				return getCheckInDateTime();
			case OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__CHECK_OUT_DATE_TIME:
				return getCheckOutDateTime();
			case OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__GUEST:
				return getGuest();
			case OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY__BOOKING_REFERENCE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OccupancyPackage.OCCUPANCY_COMPONENT_OCCUPANCY___OCCUPANCY__INT_INT_OCCUPANCYCOMPONENT_GUEST_STRING:
