...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Bedroom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Room.impl.RoomComponent_BedroomImpl#getBedCount <em>Bed Count</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomComponent_BedroomImpl extends RoomComponent_RoomImpl implements RoomComponent_Bedroom {
	...
	protected EClass eStaticClass() {
		return RoomPackage.Literals.ROOM_COMPONENT_BEDROOM;
	}
	...
	public void setBedCount(int newBedCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_BEDROOM__BED_COUNT, oldBedCount, bedCount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RoomPackage.ROOM_COMPONENT_BEDROOM__BED_COUNT:
				return getBedCount();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RoomPackage.ROOM_COMPONENT_BEDROOM___CREATE_BEDROOM__INT_BOOLEAN_INT_STRING_STRING_INT:
				...
				return null;
			case RoomPackage.ROOM_COMPONENT_BEDROOM___EDIT_ROOM__INT_BOOLEAN_INT_STRING_STRING_INT:
