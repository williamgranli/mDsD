...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Room</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Room.impl.RoomComponent_RoomImpl#getRoomNumber <em>Room Number</em>}</li>
 *   <li>{@link Room.impl.RoomComponent_RoomImpl#isUsable <em>Usable</em>}</li>
 *   <li>{@link Room.impl.RoomComponent_RoomImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link Room.impl.RoomComponent_RoomImpl#getRoomTypeName <em>Room Type Name</em>}</li>
 *   <li>{@link Room.impl.RoomComponent_RoomImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomComponent_RoomImpl extends MinimalEObjectImpl.Container implements RoomComponent_Room {
	...
	protected EClass eStaticClass() {
		return RoomPackage.Literals.ROOM_COMPONENT_ROOM;
	}
	...
	public void setRoomNumber(int newRoomNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_ROOM__ROOM_NUMBER, oldRoomNumber, roomNumber));
	}
	...
	public void setUsable(boolean newUsable) {
		...
		usable = newUsable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_ROOM__USABLE, oldUsable, usable));
	}
	...
	public void setPrice(int newPrice) {
		...
		price = newPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_ROOM__PRICE, oldPrice, price));
	}
	...
	public void setRoomTypeName(String newRoomTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_ROOM__ROOM_TYPE_NAME, oldRoomTypeName, roomTypeName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_ROOM__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RoomPackage.ROOM_COMPONENT_ROOM__ROOM_NUMBER:
				return getRoomNumber();
			case RoomPackage.ROOM_COMPONENT_ROOM__USABLE:
				return isUsable();
			case RoomPackage.ROOM_COMPONENT_ROOM__PRICE:
				return getPrice();
			case RoomPackage.ROOM_COMPONENT_ROOM__ROOM_TYPE_NAME:
				return getRoomTypeName();
			case RoomPackage.ROOM_COMPONENT_ROOM__DESCRIPTION:
