...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Conference Room</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Room.impl.RoomComponent_ConferenceRoomImpl#getNumberOfSeats <em>Number Of Seats</em>}</li>
 *   <li>{@link Room.impl.RoomComponent_ConferenceRoomImpl#isProjector <em>Projector</em>}</li>
 *   <li>{@link Room.impl.RoomComponent_ConferenceRoomImpl#isConferencePhone <em>Conference Phone</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomComponent_ConferenceRoomImpl extends RoomComponent_RoomImpl implements RoomComponent_ConferenceRoom {
	...
	protected EClass eStaticClass() {
		return RoomPackage.Literals.ROOM_COMPONENT_CONFERENCE_ROOM;
	}
	...
	public void setNumberOfSeats(int newNumberOfSeats) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM__NUMBER_OF_SEATS, oldNumberOfSeats, numberOfSeats));
	}
	...
	public void setProjector(boolean newProjector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM__PROJECTOR, oldProjector, projector));
	}
	...
	public void setConferencePhone(boolean newConferencePhone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM__CONFERENCE_PHONE, oldConferencePhone, conferencePhone));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM__NUMBER_OF_SEATS:
				return getNumberOfSeats();
			case RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM__PROJECTOR:
				return isProjector();
			case RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM__CONFERENCE_PHONE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM___CREATE_CONFERENCE_ROOM__INT_BOOLEAN_INT_STRING_STRING_INT_BOOLEAN_BOOLEAN:
				...
				return null;
			case RoomPackage.ROOM_COMPONENT_CONFERENCE_ROOM___EDIT_ROOM__INT_BOOLEAN_INT_STRING_STRING_INT_BOOLEAN_BOOLEAN:
